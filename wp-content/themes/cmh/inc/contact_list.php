...
if(isset($_REQUEST['exp']) && $_REQUEST['exp'] == 'contact_list'):
    ...
    // Read from Database.
    $query = "SELECT * FROM "."cmhc_contact ORDER BY `posted_date` desc";
...
class Link_Contact_List_Table extends WP_List_Table
{
    ...
    function prepare_items()
    {
       ...
       $query = "SELECT * FROM " ."cmhc_contact";
       // $query = "SELECT * FROM cmhc_contact WHERE name='vijay'";
       // print_r($query);
        /* -- Ordering parameters -- */
    ...
    {
 ?>
    <br /><span><p>If you want to export the Contact Enquiries as a CSV file, Please click the export button below.</p><a href="?page=<?php echo $_REQUEST['page']?>&exp=contact_list" id="export-contact_list" class="button" style="background-color:#0073aa; color:#fff;">Export</a></span>
    <br/>
    <br/>
    <?php       
    $records = $this->items;
