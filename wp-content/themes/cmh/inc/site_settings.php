				...
				<?php settings_fields('common-settings-group');?>
					<div class="settings-container">
						<ul class='k2b-tabs'>
							...
							<li><a href="#k2b-tab5"><span class="dashicons dashicons-location"></span>sample</a></li>
						...
						<div id="k2b-tab5" class="tab-wrapper">
							<h2>Footer Settings</h2>
							<table class="form-table">
								 <?php
								echo get_admin_input('textarea', 'sample_text', 'sample Text', get_option('sample_text'), '');
