...
if($lastid != "") {  
$reurl = get_bloginfo('url') . "/conditions/";
    ...
    <div class="row contact-details">
      <div class="col-6 form-section contact">
        ...
        <div class="contuct-details">
          ...
          <?php echo '<div class="checkboxradio-row">
            ...
            <button class="msg-button button-message button contact_submit" name="contact_submit" id="contact_submit" >Send Message
            </button>
